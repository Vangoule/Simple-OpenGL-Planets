...
void Window::Init()
{
	...
	windowHndl.create(sf::VideoMode(1366, 768), "OpenGL", sf::Style::Resize, settings);
	...
	windowHndl.setFramerateLimit(60);
...
{
	float timeSinceStart = deltaClock.getElapsedTime().asMilliseconds();
